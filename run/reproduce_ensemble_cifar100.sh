...
## SAM rho: 0.1
#python train_ensemble.py --dataset_path ../vit_selfOT/ViT-pytorch/data --dataset cifar100 \
# --epochs 200 --batch_size 128 --sam --mode 1 --model_name R10x5  \
# --lr_schedule cosine  --rho 0.1 --random_seed 333 | tee -a reproduce_ensemble_cifar100.txt
#
#python train_ensemble.py --dataset_path ../vit_selfOT/ViT-pytorch/data --dataset cifar100 \
...
python train_ensemble.py --dataset_path ../vit_selfOT/ViT-pytorch/data --dataset cifar100 \
 ...
 --lr_schedule cosine  --rho_lst 0.1_0.2 --random_seed 333 | tee -a reproduce_ensemble_cifar100.txt
